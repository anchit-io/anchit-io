...
- Provisioned scalable AWS infrastructure using Terraform (IaC), cutting resource setup time by **50%**.
- Reduced cloud infrastructure costs by **20%** through right-sizing EC2 instances and eliminating unused resources.
- Configured IAM roles, policies, and security groups following least-privilege and DevSecOps principles.

#### **Analyst – Cloud Operations & DevOps Support** — HCL Technologies *(Mar 2023 – Oct 2025)*
- Monitored 30+ AWS EC2 instances using CloudWatch and Grafana dashboards, achieving **99.9% uptime**.
- Managed 100+ incidents/service requests monthly via ServiceNow, maintaining **98%+ SLA compliance** and reducing MTTR by **35%**.
- Supported zero-downtime production deployments, reducing rollback incidents by **25%**.
- Performed Linux log analysis and root cause analysis on RHEL/Ubuntu systems, resolving 100+ critical issues within P1/P2 SLA windows.
- Administered IAM access for 50+ users, reducing unauthorized access incidents by **40%**.
- Coordinated cross-functional teams during P1/P2 incidents, driving average resolution time under **2 hours**.
...
### ⚡ "From cloud operations to cloud-native automation. Let's build reliable systems."
